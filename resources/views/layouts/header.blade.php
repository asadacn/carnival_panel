<div class="navbar-inner d-flex align-items-center justify-content-between px-3">
    <div class="navbar-left d-flex align-items-center gap-2">
        <a href="#" data-toggle="sidebar" class="nav-link nav-link-lg navbar-icon-btn menu-toggle" title="Toggle Sidebar">
            <i class="fas fa-bars"></i>
        </a>

        @if(\Illuminate\Support\Facades\Auth::user())
            <div class="d-none d-md-flex align-items-center navbar-page-title">
                <span class="navbar-page-title-icon" aria-hidden="true">
                    <i class="fas fa-home"></i>
                </span>
                <span class="navbar-page-title-text">@yield('title', __('messages.dashboard_title'))</span>
            </div>
        @endif
    </div>
    ...
    <div class="navbar-right d-flex align-items-center gap-2">
        ...
        @if(\Illuminate\Support\Facades\Auth::user())
            <div class="nav-item dropdown user-menu">
                <a href="#" data-toggle="dropdown"
                    ...
                    <span class="d-none d-lg-inline user-name">{{ \Illuminate\Support\Facades\Auth::user()->name }}</span>
                    <i class="fas fa-chevron-down ms-2 navbar-caret"></i>
                </a>
        ...
        @else
            <div class="nav-item dropdown user-menu">
                <a href="#" data-toggle="dropdown"
                    class="nav-link dropdown-toggle nav-link-lg nav-link-user d-flex align-items-center">
                    <span class="d-none d-lg-inline user-name">{{ __('messages.common.hello') }}</span>
                </a>
                <div class="dropdown-menu dropdown-menu-end shadow-lg border-0 navbar-dropdown">
