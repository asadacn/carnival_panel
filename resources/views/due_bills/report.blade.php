    ...
    <div class="report-container">
        ...
        <div class="page-header">
            ...
            <div class="header-actions">
                <a href="{{ route('due-bills.index') }}" class="btn btn-outline-secondary d-flex align-items-center gap-2" style="border-radius: 8px; font-weight: 600; padding: 0.45rem 0.9rem;">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-4">
                <div class="summary-card" style="--metric-accent:#f43f5e; --metric-soft:rgba(244,63,94,.10);">
                    <div class="summary-content">
                        <h6>Total Due</h6>
