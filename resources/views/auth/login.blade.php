...
@section('content')
    <div class="card card-primary">
        <div class="card-header"><h4>@lang('messages.login_title')</h4></div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <input aria-describedby="emailHelpBlock" id="email" type="email"
                           ...
                           placeholder="@lang('messages.email_placeholder')" tabindex="1"
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="remember">@lang('messages.remember_me')</label>
                    </div>
                </div>
