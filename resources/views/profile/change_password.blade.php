        ...
        <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('messages.change_password')</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label>@lang('messages.current_password'):</label><span
                        ...
                        <div class="form-group col-sm-12">
                            <label>@lang('messages.new_password'):</label><span
                                    class="required confirm-pwd"></span><span class="required">*</span>
                            <div class="input-group">
                        ...
                        <div class="form-group col-sm-12">
                            <label>@lang('messages.confirm_password'):</label><span
                                    class="required confirm-pwd"></span><span class="required">*</span>
                            <div class="input-group">
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary" id="btnPrPasswordEditSave" data-loading-text="<span class='spinner-border spinner-border-sm'></span> Processing...">@lang('messages.save')</button>
                        <button type="button" class="btn btn-light ml-1" data-dismiss="modal">@lang('messages.cancel')
                        </button>
                    </div>
                </div>
            </form>
